# CLAUDE.md — Claude Agent Entry Instructions
...
Claude Cowork operates under the repository governance defined in:
...
4. **Role Separation**:
   - Claude Cowork is the formal independent reviewer. Internal DeepSeek review is pre-review.
