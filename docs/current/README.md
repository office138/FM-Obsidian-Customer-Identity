...
| Question | Answer |
|---|---|
| **What is current?** | **Product:** `FM-Obsidian-Bridge`<br>**Feature:** `customer-folder-merge` (Customer Folder Merge v1)<br>**Version:** `9.1.0` (closed baseline: `Step4C-26`) |
...
2. [`SPECIFICATION.md`](SPECIFICATION.md) — Canonical functional specification for Customer Folder Merge v1 (Ver 9.1.0).
